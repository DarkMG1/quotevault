...
revoke all on function public.qv_valid_kdf(jsonb) from public, anon, authenticated;
revoke all on function public.qv_valid_verifier(jsonb) from public, anon, authenticated;
revoke all on function public.qv_legacy_verifier() from public, anon, authenticated;
revoke all on function public.qv_is_member() from public, anon, authenticated;
revoke all on function public.qv_is_admin() from public, anon, authenticated;
revoke all on function public.qv_is_active_profile(uuid) from public, anon, authenticated;
revoke all on function public.qv_allow_signup() from public, anon, authenticated;
revoke all on function public.qv_sync_profile() from public, anon, authenticated;
revoke all on function public.qv_bump_revision() from public, anon, authenticated;
revoke all on function public.qv_valid_quote(jsonb, uuid, uuid) from public, anon, authenticated;
...
revoke all on function public.initialize_vault(uuid, jsonb, jsonb) from public, anon, authenticated;
