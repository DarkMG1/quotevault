...
for migration in supabase/migrations/20260922080000_*.sql supabase/migrations/20260922090000_*.sql; do
  test -f "$migration" && psql -X -v ON_ERROR_STOP=1 -d "$test_db" -f "$migration"
done
