...
export async function deleteDeviceState(accountId: string): Promise<void> { uuidValue(accountId, 'account ID'); await db.deviceState.delete(accountId); }
